...
export default class ProductsListFilters extends Component {
    ...
    fetchAllProductCategories = () => {
        ...
        const url = `${base_url}/wp-json/wc/v3/products/categories?per_page=20&page=${this.state.productCategoriesPage}`;
        ...
        return (
            ...
            >
                ...
                <TouchableOpacity
                    ...
                    onPress={() => {
                        let selectedProductStockStatusValue = null
                        switch (this.state.selectedProductStockStatus) {
                            case "none":
                                selectedProductStockStatusValue = null
                                break;
                            case "instock":
                                selectedProductStockStatusValue = true
                                break;
                            case "outofstock":
                                selectedProductStockStatusValue = false
                                break;
                        }
                        this.props.onApplyFilter({
                            ...
                            "productStockStatus": selectedProductStockStatusValue,
